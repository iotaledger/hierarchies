...
impl WasmAddRootAuthority {
    ...
    #[wasm_bindgen(constructor)]
    pub fn new(federation_id: WasmObjectID, account_id: WasmObjectID, signer_address: WasmAddress) -> Result<Self> {
...
impl WasmAddProperty {
    ...
    #[wasm_bindgen(constructor)]
    pub fn new(federation_id: WasmObjectID, property: &WasmProperty, owner: WasmAddress) -> Result<Self> {
        let federation_id = parse_wasm_object_id(&federation_id)?;
